// app/(admin)/components/admins/ResetAdminPasswordDialog.tsx
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Set a new password for admin {"'" + admin.username + "'"}. They will need to use this password for their next login.
          </DialogDescription>
        </DialogHeader>
